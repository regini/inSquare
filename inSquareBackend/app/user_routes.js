...
router.patch('/user/:service', function(req, res){
  ...
  if(userId!=undefined && userId!=null && userId!=""){
    ...
    && (service=="Facebook" || service=="Google")){
      User.findById(userId, function(err, user){
        if (err) console.log(err);
          ...
          if(profilePhoto!=undefined && profilePhoto!=null && profilePhoto!=""){
            user.facebook.profilePhoto=profilePhoto;
          }
          ...
          if(profilePhoto!=undefined && profilePhoto!=null && profilePhoto!=""){
            user.google.profilePhoto=profilePhoto;
          }
          if(token!=undefined && token!=null && token!=""){
    ...
    res.send("Utente NON aggiornato! Campo service non specificato");
    }
  } else {
    res.send("Utente NON aggiornato! User id non specificata");
  }
})
